...
<?php 	
    ...
    // get profit from service
    $service_query = "SELECT SUM(total) as service_total FROM service";
    $service_result = mysqli_query($conn, $service_query);
    $service_row = mysqli_fetch_assoc($service_result);
    $service_total = $service_row['service_total'] ? $service_row['service_total'] : 0;
...
<body>
   <div class="databox">
        ...
        <div class="box profitbox" style="width: 45%;">
        <h2>Total Profit</h1>  
          <h1><?php echo $tot?> <span>RM</span></h1>
        </div>
    </div>
    <div class="chartbox">
